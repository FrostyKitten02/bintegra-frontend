...
export default function FancyPlanCard ({features, name, price, priceInterval}:{features: string[], name: string, price: number, priceInterval: PriceInterval}) {
    return(
        <div className={"w-full flex max-w-sm group"}>
            <div className={"sm:group-hover:scale-125 ease-in-out absolute duration-700 bg-gray-900 z-19 polygon-diagonal h-80 w-80"}>
            </div>
            <div className={"absolute bg-sage-green z-19 sm:group-hover:scale-110 ease-in-out duration-700 polygon-diagonal-second h-96 w-96"}>
            </div>
            <div className="transition sm:hover:scale-105 duration-1000 z-20 mt-4 ml-4 p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
