    ...
    return(
        <div className="mb-32 text-gray-800 grid justify-items-center pt-12">
            ...
            <div className="w-full flex justify-center">
                <div className="z-60 bg-red-500 absolute w-[470px] h-96">
                        hej
                </div>
                <div className="z-59 mt-5 ml-5 relative w-full max-w-[350px] hover:transition ease-in-out hover:duration-700 duration-700 hover:scale-105 sm:max-w-[450px] p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
                    <form className="space-y-6"
                        ...
                        <button type="submit"
                                className="w-full text-white bg-red-400 hover:bg-gray-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                            Registrirajte se
                        </button>
